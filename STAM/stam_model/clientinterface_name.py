#!/usr/bin/env python
"""
    Container class for storing the contents of an ClientInterface_name statement in the STAM language.

    This file contains the contents of what was parsed from a STAM file for what was discovered in the
    ClientInterface_name statement.  The objects of this class will be contained in the module objects as individual
    instances of each of the client interface names defined.  This class also defines visitor methods for each type of
