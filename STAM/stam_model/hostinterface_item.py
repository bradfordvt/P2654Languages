#!/usr/bin/env python
"""
    Container class for storing the contents of an HostInterface_item statement in the STAM language.

    This file contains the contents of what was parsed from a STAM file for what was discovered in the
    HostInterface_item statement.  The objects of this class will be contained in the module objects as individual
